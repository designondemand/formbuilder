...
class fbTextField extends fbFieldBase {
	...
	function __construct(fbForm &$FormInstance, &$params)
	{
		...
		$this->ValidationTypes = array(
            ...
            $this->Lang('validation_numeric')=>'numeric',
            $this->Lang('validation_integer')=>'integer',
            $this->Lang('validation_usphone')=>'usphone',
            $this->Lang('validation_email_address')=>'email',
            $this->Lang('validation_regex_match')=>'regex_match',
            $this->Lang('validation_regex_nomatch')=>'regex_nomatch'
            );
	}
