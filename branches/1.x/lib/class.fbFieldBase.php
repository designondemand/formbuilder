...
abstract class fbFieldBase {
  ...
  function LoadField(&$params)
  {
	...
	// Change this method name to Save
		...
		if ($storeDeep) {
			...
			*/	
				foreach ((array)$thisOptValueList as $thisOptValue)
				{
					...
					$db->Execute($sql, array($optId, $this->Id, $this->FormId, $thisOptKey, $thisOptValue));
				}
			}
		}
		return true; // Neccery?
